      ...
      {shouldShow && (
        <div className="space-y-6">
          <div>
            ...
            <p className="mb-4">
              <strong>Ambivator</strong> is forked from{" "}
              <a
            ...
            <div className="bg-base-100 p-6 rounded-lg shadow-md space-y-4">
              ...
              <p>
                ...
                — a simple, zero-configuration command-line static file server.
              </p>
              ...
              <p>
                If the video shows someone streaming 3D/large data using a local
                server, they are almost certainly using the{" "}
                <code>http-server</code> npm tool. It's compatible with{" "}
                <code>viv</code> and supports all necessary features.
              </p>
            </div>
          </div>
        </div>
